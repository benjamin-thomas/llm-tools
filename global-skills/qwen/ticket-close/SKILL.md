...
Things that do NOT belong: coding patterns, framework conventions, file structure, test strategies, refactoring decisions. These are either observable from the code or belong in project config files.
